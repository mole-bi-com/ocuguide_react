...
const InfoStep = ({ step, patientInfo, currentCardIndex, setCurrentCardIndex }) => {
  ...
  const getAudioUrl = (caption) => {
    const audioMap = {
      ...
      '백내장 수술의 부작용에는 어떤 것들이 있나요?': '/contents/q4_1.mp3'
    };
